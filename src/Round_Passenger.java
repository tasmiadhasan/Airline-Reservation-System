...
public class Round_Passenger {
    ...
    Round_Passenger(String name,String passport,String address,String phone,String classtype,int tickets,int total_price)
    {
        this.name=name;
    ...
    public void printInvoice(){
        Round_FlightCheck newinv=new Round_FlightCheck();
        newinv.Round_Fly();
